...
class Canvas {
	...
	/**
	 * Creates a wrapper around <canvas> element
	 * @param {(string|HTMLCanvasElement|CanvasRenderingContext2D)} canv String representing an ID of element, or element itself.
	 * @throws {TypeError} If supplied argument type does not match mentioned requirements.
	 * @throws {Error} If there is no <canvas> element on a page.
	 */
	constructor(canv){
		let c;
		if(typeof canv === "string"){
			...
			throw new TypeError("First argument must be a string or instance of canvas element or instance of context class");
		}
